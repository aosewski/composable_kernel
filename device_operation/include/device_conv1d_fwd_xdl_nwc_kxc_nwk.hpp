#ifndef DEVICE_CONV1D_FWD_XDL_NWC_KXC_NWK_HPP
#define DEVICE_CONV1D_FWD_XDL_NWC_KXC_NWK_HPP
...
struct DeviceConv1dFwdXdl_Input_N_Wi_C_Weight_K_X_C_Output_N_Wo_K
    : public DeviceConvFwd<InElementwiseOperation, WeiElementwiseOperation, OutElementwiseOperation>
{
    using DeviceOp = DeviceConv1dFwdXdl_Input_N_Wi_C_Weight_K_X_C_Output_N_Wo_K;
    ...
    static constexpr index_t NDimSpatial = 1;
                                                    ...
                                                    std::vector<ck::index_t> input_right_pads)
    {
        ...
        const index_t GemmMRaw = N * Wo;
        const index_t GemmN    = K;
        const index_t GemmK    = X * C;
                     ...
                     ConvolutionForwardSpecialization_t::Filter1x1Stride1Pad0)
        {
            ...
            const auto in_gemmmraw_gemmk_grid_desc =
                make_naive_tensor_descriptor_packed(make_tuple(N * Wo, C));
        ...
        else
        {
            ...
            // C: output tensor
            const auto out_nwo_k_grid_desc =
                make_naive_tensor_descriptor_packed(make_tuple(N * Wo, K));

            const auto out_gemmmraw_gemmn_grid_desc =
                transform_tensor_descriptor(out_nwo_k_grid_desc,
    ...
    static bool IsSupportedArgument(const Argument& arg)
    {
                     ...
                     ConvolutionForwardSpecialization_t::Filter1x1Stride1Pad0)
        {
            ...
            if(!(arg.filter_spatial_lengths_[0] == 1 &&
                 arg.conv_filter_strides_[0] == 1 &&
                 arg.input_left_pads_[0] == 0  &&
                 arg.input_right_pads_[0] == 0))
            {
                return false;
            }
        }
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceConv1dFwdXdl_Input_N_Wi_C_Weight_K_X_C_Output_N_Wo_K"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "
